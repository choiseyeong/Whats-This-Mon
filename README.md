...
| Experiment | Model | Test Accuracy | Test Precision | Test Recall | F1-score |
|:---:|:---|:---:|:---:|:---:|:---:|
| Exp 1 | ResNet18-scratch | 0.7586 | 0.7753 | 0.7543 | 0.7474 |
| Exp 2 | ResNet18-linear-probe | 0.8211 | 0.8382 | 0.8150 | 0.8130 |
| Exp 3 | ResNet18-partial | 0.9228 | 0.9275 | 0.9192 | 0.9179 |
| **Exp 4** | **ResNet18-full-FT** | **0.9443** | **0.9443** | **0.9408** | **0.9389** |
